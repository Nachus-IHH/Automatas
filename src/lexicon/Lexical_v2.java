...
/**
 * Lee un archivo caracter por caracter, elimina espacios en blanco
 */
public class Lexical_v2 {
    public static StringBuilder currentLexeme = new StringBuilder();
    //private static final char[] blankSpaces = {' ', '\t', '\n'};  //is the same with Character.isWhitespace(symbol)
    ...
    public static boolean analyze(String filePath, FA fa) {
        ...
        try (SourceReader sr = new SourceReader(filePath)) {
            ...
            System.err.println("Error en Lexical_v2: " + e.getMessage());
            e.printStackTrace();
        }
        if (fa instanceof DFA dfa) {
